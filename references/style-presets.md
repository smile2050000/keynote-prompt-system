...
- 质感来自克制留白、细腻材质、低反射金属、白色聚合物、玻璃和柔软织物，不靠梦幻特效或装饰堆叠。
- 采用真实商业广告摄影：柔和日光或柔和影棚主光，轻微辅光和受控轮廓光，清晰中间调、真实接触阴影和受控高光；画面明亮但不硬、不灰、不雾、不漂白。
- 气质偏现代高端女性生活方式：精致、轻盈、有空间设计感，但不少女化、不美妆广告化、不婚礼展台化。
- 排版使用现代无衬线字体，标题层级清楚，留白稳定；产品与人物关系偏精致日常，产品保持清晰、高对比和真实结构。
- 家庭或生活场景只保留支持产品语境的家具、材质和动作；不使用丝绸帷幕、金色描边、舞台基座、花瓣、蝴蝶结或装饰性光球作为默认答案。
- 最高风险：梦幻光球、粉紫渐变泛滥、少女化图标、暖黄滤镜、灰雾、过曝、塑料感、软装堆砌或美妆广告化。
